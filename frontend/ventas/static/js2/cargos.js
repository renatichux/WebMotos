    ...
    function cargosActualizar(){
        ...
        $.ajax({
            ...
            data: parametros,  // Envio deParámetro
            async: false,      // Sincrónico
            url: url_api + lo_path +  document.getElementById('txCodigo').value  ,  // Url de la API
            cache: false,
            dataType: "json",             // Formato de envio
            beforeSend: function (data){
                // Método de ejecuta antes de enviar
    ...
    function cargosLeer(){
        ...
        // No Tiene parametros
        //*********** Ejecuto Ajax Sincrónico
        var pathUrl= url_api + lo_path +  document.getElementById('txCodigo').value
        $.ajax({
            ...
            success: function (data) {
                ...
                document.getElementById('txNombre').value = json.registro.nombre
                document.getElementById('cbRegion').value = json.registro.papellido
                document.getElementById('txDireccion').value = json.registro.direccion
                habilitaLeer()
            }
        });
    }
    function cargoEliminar(){
